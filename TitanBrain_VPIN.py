...
def process_symbol_task(sym, active, mission_state):
    ...
    try:
        ...
        is_hard_blocked = any(kw in block_reason for kw in ["MARGEN", "MAX BALAS", "SPREAD BALLENA", "SPREAD PROHIBITIVO", "ANTI-WHIPSAW", "MERCADO CERRADO", "PRE-CIERRE", "RETROCESO", "DIP", "REBOTE", "CAOS", "PRECIO CAYENDO", "PRECIO SUBIENDO", "VETO: TENDENCIA"])
            ...
            # Caso B: Acumular (ESCALADOR DE METRALLETA v39.9)
                ...
                if not block_action or (is_oracle_signal and not is_hard_blocked):
                    ...
                    if n_balas == 0:
                        ...
                        # v18.9.138: (BORRADO) Hedge permitido para mayor fluidez.
                        pass
